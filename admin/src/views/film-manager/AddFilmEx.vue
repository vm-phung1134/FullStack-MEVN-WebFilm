<template>
    <div class="container font-weight-light">
        <div class="my-md-2 p-md-5">
           <form class="shadow-content p-4 font-label" @submit.prevent="createFilm()">
                <div>
                    <h4 class="text-cinema text-center mt-md-1 font-weight-light">THÊM PHIM MỚI - PHIM SẮP KHỞI CHIẾU</h4>
                ...
                <div class="mb-3">
                    ...
                    <input v-model="film.date" type="date" class="form-control">
                </div>
                <div class="mb-3">
...
<script>
    ...
    export default {
        ...
        methods: {
            async createFilm(){
            try{
                await API_Ex.create(this.film);
                this.film = "";
                alert('Đã thêm 1 bộ phim vào hệ thống');
            }catch(e){
                console.log(e);
            }
        }
